...
default_state = json.loads('{"BarChart1":{"styles":{"width":"","height":"","minWidth":"","minHeight":"","maxWidth":"","maxHeight":"","overflow":""},"custom":{"cartesianGrid":{"show":false,"strokeDasharray":""},"data":[],"xAxis":{"show":false,"key":""},"yAxis":{"show":false},"toolTip":{"show":false},"legend":{"show":false},"stacked":false,"options":{}}}}')
...
class Atri:
	def __init__(self, state: Any):
		...
		self.BarChart1 = state["BarChart1"]
		self._setter_access_tracker = {}
	...
	@property
	def BarChart1(self):
		self._getter_access_tracker["BarChart1"] = {}
		return self._BarChart1
	@BarChart1.setter
	def BarChart1(self, new_state):
		self._setter_access_tracker["BarChart1"] = {}
		global default_state
		self._BarChart1 = BarChart(new_state, default_state["BarChart1"])

	def _to_json_fields(self):
		return {
			"BarChart1": self._BarChart1,
			}
